...
},{"@babel/runtime/helpers/esm/objectSpread2":"node_modules/@babel/runtime/helpers/esm/objectSpread2.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var createClaim = function createClaim(name, amount) {
  return {
    type: 'CREATE_CLAIM',
    payload: {
      name: name,
...
var deletePolicy = function deletePolicy(name) {
  return {
    type: 'DELETE_POLICY',
    payload: {
      name: name
...
var claims = function claims() {
  var listofclaims = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var action = arguments.length > 1 ? arguments[1] : undefined;
  if (action.type === 'CREATE_CLAIM') {
...
var policy = function policy() {
  var listofpeoplewithpolicies = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var action = arguments.length > 1 ? arguments[1] : undefined;
  if (action.type === 'CREATE_POLICY') {
    return [].concat(_toConsumableArray(listofpeoplewithpolicies), [action.payload.name]);
  }
  if (action.type === 'DELETE_POLICY') {
    return listofpeoplewithpolicies.filter(function (name) {
      return name !== action.payload.name;
    });
  }
  return listofpeoplewithpolicies;
};
var ourdepartmentsdata = (0, _redux.combineReducers)({
  policy: policy,
  claims: claims,
  accounting: accounting
});
var store = (0, _redux.createStore)(ourdepartmentsdata);
